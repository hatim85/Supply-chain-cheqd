...
// //   try {
// //     // Helper function to create a single DID
...
// //     // Create Subject DID
// //     const subjectResult = await createSingleDID(subjectIdentifier, 'Subject');
...
// // //     credentialSubject: {
// // //       id: subjectDid, // Include Subject DID as per previous update
// // //       ...credentialData
// // //     }
// // //   };

// // //   console.log('Constructed VC before signing:', vc);

// // //   const proof = jwt.sign(vc, 'secret-key', { algorithm: 'HS256' });
// // //   console.log('JWT proof generated:', proof);

// // //   vc.proof = { type: 'JwtProof2020', jwt: proof };
// // //   console.log('VC with proof:', vc);
...
// // //   // Simulate signing with JWT (in production, use cheqd's signing API or private key)
// // //   const proof = jwt.sign(vc, 'secret-key', { algorithm: 'HS256' });
// // //   vc.proof = { type: 'JwtProof2020', jwt: proof };

// // //   try {
// // //     const response = await axios.post(
// // //       `${cheqdStudioApiUrl}/credential/issue`,
// // //       vc,
// // //       { headers: { Authorization: `Bearer ${cheqdApiKey}` } }
// // //     );
// // //     return response.data;
// // //   } catch (error) {
// // //     throw new Error(`Failed to issue VC: ${error.response?.data?.message || error.message}`);
...
// //     jwt.verify(vc.proof.jwt, 'secret-key');
    
// //     // Call cheqd Studio API to verify VC
// //     const response = await axios.post(
// //       `${cheqdStudioApiUrl}/credential/verify`,
// //       vc,
// //       { headers: { Authorization: `Bearer ${cheqdApiKey}` } }
// //     );
...
// //       `${cheqdStudioApiUrl}/trust-registry/issuers`,
// //       { headers: { Authorization: `Bearer ${cheqdApiKey}` } }
// //     );
// //     return response.data.includes(issuerDid);
// //   } catch (error) {
// //     console.error('Error checking trust registry:', error);
// //     return false;
// //   }
// // };
...
//     url,
//     data: vc,
//     headers: { ...headers, 'pinata_api_key': 'REDACTED', 'pinata_api_secret': 'REDACTED' }
//   });
